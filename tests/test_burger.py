...
def test_burger_bun_with_filling():
    bun_name = 'bip_bun'
    bun = Bun(name=bun_name, price=1.1)
...
def test_burger_bun_with_sause():
    bun_name = 'bip_bun'
    bun = Bun(name=bun_name, price=1.1)
...
def test_burger_bun_total_price(name, price):
    bun = Bun(name, price)
    burger = Burger()
    burger.set_buns(bun)
...
def test_burger_bun_ingredient_total_price(name, price):
    ingredients_list = [
